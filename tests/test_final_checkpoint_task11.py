...
def test_backend_api_structure():
    ...
    with open(tool_router_path, encoding='utf-8') as f:
        content = f.read()
    ...
    with open(v1_init_path, encoding='utf-8') as f:
        content = f.read()
...
def test_frontend_components():
    ...
    with open(excelimp_component, encoding='utf-8') as f:
        content = f.read()
    ...
    with open(formatter_component, encoding='utf-8') as f:
        content = f.read()
...
def test_routing_configuration():
    ...
    with open(cn_i18n, encoding='utf-8') as f:
        content = f.read()
